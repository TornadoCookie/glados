...
int main() {
    ...
    printf("Tier 1: The Heimlich Counter-Maneuver - A reliable technique for interrupting the life-saving Heimlich Maneuver.\n\n\n");
    ...
    printf("initiatives. The company announces products related to the research in a lavish, televised ceremony. These\n");
    printf("products become immediately wildly unpopular. After a string of very public choking and despondent sick child\n");
    printf("disasters, senior company officials are summoned before a Senate investigative committee. During these\n");
    printf("proceedings, an engineer mentions that some progress has been made on Tier 3, the 'man-sized ad hock quantum\n");
    printf("tunnel through physical space with possible applications as a shower curtain.' The committee is quickly\n");
    printf("permanently recessed, and Aperture is granted an open-ended contract to secretly continue research on the\n");
    printf("'Portal' and Heimlich Counter-Maneuver projects.\n\n\n\n");
    more();
    ...
    printf("1986 - Word reaches Aperture management that another defense contractor called Black Mesa is working on a\n");
    printf("similar portal technology. In response to this news, Aperture begins developing the Genetic Lifeform and Disk\n");
    printf("Operating System (GLaDOS), an artificially intelligent research assistant and disk operating system.\n\n\n");
    printf("1996 - After a decade spent bringing the disk operating parts of GLaDOS to a state of more or less basic\n");
    ...
    printf("In many ways, the initial test goes well...\n\n\n\n");
    printf("[END]");
    getchar();
    clear();
    return 0;
